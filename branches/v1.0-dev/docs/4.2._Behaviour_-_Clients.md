...
[←Behaviour - Authorization Servers ](4.1._Behaviour_-_Authorization_Servers.md) · [ Index↑ ](..) · [Behaviour - Token Requests→](4.3._Behaviour_-_Token_Requests.md)
...
[Resource Servers - Operation with WebSocket](4.5._Behaviour_-_Resource_Servers.md#operation-with-websocket).
