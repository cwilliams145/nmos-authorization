...
[![Build Status](https://travis-ci.com/AMWA-TV/nmos-authorization.git.svg)](https://travis-ci.com/AMWA-TV/nmos-authorization.git)
...
The formal specification is provided in [this GitHub repository](https://github.com/AMWA-TV/nmos-authorization.git). These pages provide supporting documentation and HTML renders of the APIs (which are specified in RAML and JSON Schema).
